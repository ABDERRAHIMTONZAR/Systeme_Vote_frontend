...
export default function VotePage() {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API_URL}/sondage/${id_sondage}`)
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API_URL}/sondage/options/${id_sondage}`)
  ...
  const submitVote = async () => {
    ...
    try {
      await axios.post(
        `${process.env.REACT_APP_API_URL}/vote/insert`,
